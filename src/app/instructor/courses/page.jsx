...
export default function InstructorCoursesPage() {
  ...
  // TODO: 강사가 담당하는 과정 데이터 (API에서 가져오기)
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold" style={{ color: "#9b59b6" }}>
                      {courses.reduce((sum, course) => sum + (course.students || 0), 0)}명
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold" style={{ color: "#e74c3c" }}>
                      {courses.reduce((sum, course) => sum + (course.pendingGrades || 0), 0)}개
                    </p>
                  </div>
              ...
              {filteredCourses.length === 0 ? (
                <div className="p-12">
                  <EmptyState
                    icon={BookOpen}
                    title="담당 과정이 없습니다"
                    description="현재 담당하고 계신 과정이 없습니다. 관리자에게 문의해주세요."
                  />
                </div>
              ) : (
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredCourses.map((course) => (
                        <tr key={course.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-gray-900">
                                {course.students || 0}/{course.maxStudents || 0}명
                              </span>
                            </div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">과제 {course.assignments || 0}개</div>
                            {(course.pendingGrades || 0) > 0 && (
