...
export default function InstructorLecturesPage() {
  ...
  useEffect(() => {
    ...
    if (userData) {
      ...
      console.log("memberId(Number):", memberId, "typeof:", typeof memberId)
      if (isNaN(memberId)) {
        console.error("memberId가 NaN입니다! 로그인 정보를 확인하세요.")
        setLoading(false)
        return
      }
      fetchInstructorLectures(memberId)
        .then((data) => {
          ...
          console.log("변환된 lectures:", lecturesData)
                      ...
                      <tr key={lecture.courseId} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex space-x-2">
                            <Link href={`/instructor/courses/lectures/${lecture.courseId}`}>
